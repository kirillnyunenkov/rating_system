...
INIT_SQL = "CREATE TABLE IF NOT EXISTS items(user_id TEXT, list_id TEXT, \
place INT, name TEXT, is_sorted BIT, is_favorite BIT)"
GET_ITEMS = "SELECT name FROM items WHERE user_id = '{}' AND list_id = '{}' \
ORDER BY place ASC"
GET_LISTS = "SELECT list_id FROM items WHERE user_id = '{}'"
GET_RATINGS = "SELECT list_id FROM items WHERE user_id = '{}' AND \
is_sorted = 1"
GET_FAVORITES = "SELECT list_id FROM items WHERE user_id = '{}' AND \
is_favorite = 1"
INSERT_LIST = "INSERT INTO items VALUES(?, ?, ?, ?, ?, ?)"
DELETE_LIST = "DELETE FROM items WHERE user_id = '{}' AND list_id = '{}'"
DELETE_ITEM = "DELETE FROM items WHERE user_id = '{}' AND list_id = '{}' \
AND name = '{}'"
IS_SORTED = "SELECT is_sorted FROM items WHERE user_id = '{}' AND \
list_id = '{}'"
IS_FAVORITE = "SELECT is_favorite FROM items WHERE user_id = '{}' AND \
list_id = '{}'"
